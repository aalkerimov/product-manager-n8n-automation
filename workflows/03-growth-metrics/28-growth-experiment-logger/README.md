# 28 - Growth Experiment Logger

> **Category:** 03-growth-metrics | **Trigger:** Webhook + Schedule (Sun 17:00) | **AI:** No

## What it does
Automates growth experiment logger for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
