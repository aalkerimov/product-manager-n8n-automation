# 24 - Cohort Churn Detector

> **Category:** 03-growth-metrics | **Trigger:** Schedule (last day of month) | **AI:** No

## What it does
Automates cohort churn detector for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
