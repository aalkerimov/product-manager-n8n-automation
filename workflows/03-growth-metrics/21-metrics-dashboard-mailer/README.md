# 21 - Metrics Dashboard Mailer

> **Category:** 03-growth-metrics | **Trigger:** Schedule (Mon 07:30) | **AI:** No

## What it does
Automates metrics dashboard mailer for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
