# 22 - Revenue Health Monitor

> **Category:** 03-growth-metrics | **Trigger:** Schedule (1st of month) | **AI:** No

## What it does
Automates revenue health monitor for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
