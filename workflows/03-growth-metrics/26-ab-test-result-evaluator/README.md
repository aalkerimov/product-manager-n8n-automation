# 26 - AB Test Result Evaluator

> **Category:** 03-growth-metrics | **Trigger:** Webhook (test data POST) | **AI:** No

## What it does
Automates ab test result evaluator for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
