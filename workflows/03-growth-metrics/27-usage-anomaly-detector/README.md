# 27 - Usage Anomaly Detector

> **Category:** 03-growth-metrics | **Trigger:** Schedule (daily 06:00) | **AI:** No

## What it does
Automates usage anomaly detector for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
