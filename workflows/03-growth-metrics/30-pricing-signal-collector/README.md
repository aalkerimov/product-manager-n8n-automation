# 30 - Pricing Signal Collector

> **Category:** 03-growth-metrics | **Trigger:** Schedule (1st/15th) | **AI:** Yes (OpenAI)

## What it does
Automates pricing signal collector for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
