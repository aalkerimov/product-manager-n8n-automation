# 25 - NPS Pulse Tracker

> **Category:** 03-growth-metrics | **Trigger:** Webhook (NPS response received) | **AI:** No

## What it does
Automates nps pulse tracker for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
