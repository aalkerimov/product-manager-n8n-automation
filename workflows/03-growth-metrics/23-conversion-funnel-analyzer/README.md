# 23 - Conversion Funnel Analyzer

> **Category:** 03-growth-metrics | **Trigger:** Schedule (Mon 08:00) | **AI:** No

## What it does
Automates conversion funnel analyzer for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
