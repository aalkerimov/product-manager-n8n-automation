# 31 - Support Ticket Classifier

> **Category:** 04-customer-feedback | **Trigger:** Webhook (ticket received) | **AI:** Yes (OpenAI)

## What it does
Automates support ticket classifier for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
