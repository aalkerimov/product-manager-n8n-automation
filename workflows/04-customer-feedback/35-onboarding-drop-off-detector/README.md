# 35 - Onboarding Drop-off Detector

> **Category:** 04-customer-feedback | **Trigger:** Schedule (Mon 10:00) | **AI:** No

## What it does
Automates onboarding drop-off detector for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
