# 39 - Renewal Risk Alerter

> **Category:** 04-customer-feedback | **Trigger:** Schedule (Mon 08:30) | **AI:** No

## What it does
Automates renewal risk alerter for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
