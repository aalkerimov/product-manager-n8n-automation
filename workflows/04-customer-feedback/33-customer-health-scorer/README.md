# 33 - Customer Health Scorer

> **Category:** 04-customer-feedback | **Trigger:** Schedule (weekly Sunday) | **AI:** No

## What it does
Automates customer health scorer for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
