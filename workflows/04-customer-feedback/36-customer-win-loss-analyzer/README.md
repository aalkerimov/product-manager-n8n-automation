# 36 - Customer Win-Loss Analyzer

> **Category:** 04-customer-feedback | **Trigger:** Schedule (1st of month) | **AI:** Yes (OpenAI)

## What it does
Automates customer win-loss analyzer for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
