# 38 - NPS Follow-up Automator

> **Category:** 04-customer-feedback | **Trigger:** Webhook (NPS response received) | **AI:** Yes (OpenAI)

## What it does
Automates nps follow-up automator for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
