# 49 - Product News Digest

> **Category:** 05-founder-intelligence | **Trigger:** Schedule (Mon 07:30) | **AI:** Yes (OpenAI)

## What it does
Automates product news digest for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
