# 48 - Press Mention Aggregator

> **Category:** 05-founder-intelligence | **Trigger:** Schedule (Tue & Fri 09:00) | **AI:** Yes (OpenAI)

## What it does
Automates press mention aggregator for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
