# 47 - Competitive Pricing Scanner

> **Category:** 05-founder-intelligence | **Trigger:** Schedule (Mon 07:00) | **AI:** Yes (OpenAI)

## What it does
Automates competitive pricing scanner for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
