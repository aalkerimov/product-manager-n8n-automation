# 45 - Team Sentiment Monitor

> **Category:** 05-founder-intelligence | **Trigger:** Schedule (Fri 18:00) | **AI:** No

## What it does
Automates team sentiment monitor for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
