# 43 - Investor Update Composer

> **Category:** 05-founder-intelligence | **Trigger:** Schedule (5th of month) | **AI:** Yes (OpenAI)

## What it does
Automates investor update composer for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
