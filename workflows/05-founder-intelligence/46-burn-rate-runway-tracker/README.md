# 46 - Burn Rate Runway Tracker

> **Category:** 05-founder-intelligence | **Trigger:** Schedule (5th of month) | **AI:** No

## What it does
Automates burn rate runway tracker for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
