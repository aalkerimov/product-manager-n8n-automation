# 42 - Founder Daily Brief

> **Category:** 05-founder-intelligence | **Trigger:** Schedule (weekdays 07:00) | **AI:** Yes (OpenAI)

## What it does
Automates founder daily brief for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
