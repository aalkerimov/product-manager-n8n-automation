# 41 - Market Signal Radar

> **Category:** 05-founder-intelligence | **Trigger:** Schedule (Fri 16:00) | **AI:** Yes (OpenAI)

## What it does
Automates market signal radar for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
