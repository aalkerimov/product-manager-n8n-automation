# 44 - Hiring Signal Tracker

> **Category:** 05-founder-intelligence | **Trigger:** Schedule (Wed 09:00) | **AI:** Yes (OpenAI)

## What it does
Automates hiring signal tracker for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
