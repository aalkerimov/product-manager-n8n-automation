# 50 - Board Deck Data Collector

> **Category:** 05-founder-intelligence | **Trigger:** Schedule (monthly) | **AI:** Yes (OpenAI)

## What it does
Automates board deck data collector for product managers and founders. Set up credentials and environment variables, then trigger manually or let the schedule run automatically.
